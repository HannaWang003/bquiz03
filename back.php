...
<body>
    <div id="main">
        ...
        <div id="mm">
            ...
            ?>
                <div class="ct a rb" style="position:relative; width:101.5%; left:-1%; padding:3px; top:-9px;"> <a href="?do=tit">網站標題管理</a>|
            ...
            ?>
                <form action="" method="post" style="width:50%;margin:auto;background:lightblue">
