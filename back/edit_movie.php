...
<form action="./api/save_movie.php" method="post" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td>
                        <select name="level" id="">
                            ...
                            <option value="2" <?= ($movie['level'] == 1) ? 'selected' : '' ?>>輔導級</option>
                            <option value="3" <?= ($movie['level'] == 1) ? 'selected' : '' ?>>保護級</option>
                            <option value="4" <?= ($movie['level'] == 1) ? 'selected' : '' ?>>限制級</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <select name="month" id="">
                            ...
                            for ($i = 1; $i <= 12; $i++) {
                                ...
                                echo "<option value='$i' $selected>$i</opton>";
                            }
                            ?>
                        </select>月
                        <select name="date" id="">
    ...
    <div style="display:flex;align-items:start">
        ...
        <div style="width:85%;"><textarea name="intro" style="width:95%;height:100px;"><?= $movie['intro'] ?></textarea>
        </div>
    </div>
    <div class="ct">
